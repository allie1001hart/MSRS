...
$(document).ready(function () {
    $("#my-calendar").zabuto_calendar({
        legend: [
            { type: "text", label: "Volunteer Event", classname: "badge-info" },
            { type: "spacer" },
            { type: "text", label: "Extracurricular Event", classname: "badge-warning" },
            { type: "spacer" },
            { type: "text", label: "Recruiting Event", classname: "badge-success" },
            { type: "spacer" }
        ],
        ajax: {
